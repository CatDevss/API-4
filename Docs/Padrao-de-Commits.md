**Padrão de Commits**  
Este documento define o padrão de mensagens de commit do projeto GeoRural DataHub. O objetivo é manter o histórico do repositório organizado, facilitar a leitura do que foi feito e vincular cada commit à tarefa correspondente no backlog.  
Baseado no modelo [Conventional Commits, com um adicional: o ID da tarefa entra no lugar do escopo.](https://www.conventionalcommits.org "https://www.conventionalcommits.org")  
**Estrutura**  
