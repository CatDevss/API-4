...
<h2 align="center"><img src="https://api.iconify.design/tabler/list-details.svg?color=%23FFFFFF" width="20" /> Sumário</h2>
...
<h2 align="center"><img src="https://api.iconify.design/tabler/building-broadcast-tower.svg?color=%23FFFFFF" width="20" /> Sobre a Visiona</h2>
...
<h2 align="center"><img src="https://api.iconify.design/tabler/target-arrow.svg?color=%23FFFFFF" width="20" /> O Desafio</h2>
...
<table>
  <tr>
    ...
    <td align="center" width="50%">
      ...
      <sub>
      <img src="https://api.iconify.design/tabler/refresh.svg?color=%23FFFFFF" width="16" /> Qual versão entrou no cálculo?<br><br>
      <img src="https://api.iconify.design/tabler/shield-x.svg?color=%23FFFFFF" width="16" /> Quais registros foram rejeitados e por quê?<br><br>
      <img src="https://api.iconify.design/tabler/arrows-transfer-up.svg?color=%23FFFFFF" width="16" /> O que foi transformado no caminho?<br><br>
      <img src="https://api.iconify.design/tabler/history.svg?color=%23FFFFFF" width="16" /> O resultado pode ser reconstituído?
      </sub>
    </td>
  </tr>
</table>
...
<h2 align="center"><img src="https://api.iconify.design/tabler/map-pin.svg?color=%23FFFFFF" width="20" /> Área de Interesse</h2>
...
<h2 align="center"><img src="https://api.iconify.design/tabler/route.svg?color=%23FFFFFF" width="20" /> Objetivo e Fluxo Mínimo</h2>
...
<h2 align="center"><img src="https://api.iconify.design/tabler/list-check.svg?color=%23FFFFFF" width="20" /> Escopo e Requisitos Funcionais</h2>
...
| Requisito | Descrição |
| --- | --- |
| <img src="https://api.iconify.design/tabler/key.svg?color=%23FFFFFF" width="16" /> Acesso autenticado por perfil | Administrador, operador de dados, analista, gestor e auditor |
| <img src="https://api.iconify.design/tabler/folders.svg?color=%23FFFFFF" width="16" /> Catálogo de fontes e conjuntos | Esquema, sistema de referência, competência, cobertura e versão vigente |
| <img src="https://api.iconify.design/tabler/upload.svg?color=%23FFFFFF" width="16" /> Ingestão de dados | CSV, JSON e GeoJSON por upload ou API |
| <img src="https://api.iconify.design/tabler/refresh.svg?color=%23FFFFFF" width="16" /> Pipelines no Apache Airflow | Recebimento, validação, tratamento, cálculo, qualidade e publicação |
| <img src="https://api.iconify.design/tabler/shield-check.svg?color=%23FFFFFF" width="16" /> Qualidade e quarentena | Campos, tipos, domínios, duplicidades, áreas, coordenadas e geometrias |
| <img src="https://api.iconify.design/tabler/stack-2.svg?color=%23FFFFFF" width="16" /> Versões imutáveis e comparação | Versão vigente e anteriores, com linhagem até a fonte e a regra |
| <img src="https://api.iconify.design/tabler/world.svg?color=%23FFFFFF" width="16" /> Portal web | Mapa, tabela, gráficos, downloads e painel de execuções do Airflow |
| <img src="https://api.iconify.design/tabler/plug.svg?color=%23FFFFFF" width="16" /> APIs REST | Catálogo, dados, indicadores, versões, qualidade, linhagem e status |
| <img src="https://api.iconify.design/tabler/leaf.svg?color=%23FFFFFF" width="16" /> Cálculo analítico próprio | Interseções e agregações por imóvel, APP, RL e município |
| <img src="https://api.iconify.design/tabler/user-check.svg?color=%23FFFFFF" width="16" /> Auditoria completa | Uploads, regras, execuções, publicações, downloads e responsáveis |
...
<table>
  <tr>
    ...
    <td align="center" width="50%">
      ...
      <sub>
      <img src="https://api.iconify.design/tabler/circle-check.svg?color=%23FFFFFF" width="16" /> Cadastrar uma fonte, ingerir um conjunto e acompanhar as etapas no Airflow<br><br>
      <img src="https://api.iconify.design/tabler/circle-check.svg?color=%23FFFFFF" width="16" /> Consultar as rejeições e executar os cruzamentos e os cálculos analíticos<br><br>
      <img src="https://api.iconify.design/tabler/circle-check.svg?color=%23FFFFFF" width="16" /> Validar e publicar uma versão imutável dos resultados<br><br>
      <img src="https://api.iconify.design/tabler/circle-check.svg?color=%23FFFFFF" width="16" /> Acessar a versão por API e pelo portal, com indicadores em mapa, tabela e gráficos<br><br>
      <img src="https://api.iconify.design/tabler/circle-check.svg?color=%23FFFFFF" width="16" /> Comparar versões e rastrear um resultado até a fonte, a execução e a regra aplicada
      </sub>
    </td>
  </tr>
</table>
...
<h2 align="center"><img src="https://api.iconify.design/tabler/calendar-time.svg?color=%23FFFFFF" width="20" /> Cronograma das Sprints</h2>
...
<h2 align="center"><img src="https://api.iconify.design/tabler/code.svg?color=%23FFFFFF" width="20" /> Tecnologias Usadas</h2>
...
<h2 align="center"><img src="https://api.iconify.design/tabler/terminal-2.svg?color=%23FFFFFF" width="20" /> Como Executar o Projeto</h2>
...
<h2 align="center"><img src="https://api.iconify.design/tabler/file-text.svg?color=%23FFFFFF" width="20" /> Documentação</h2>
...
<h2 align="center"><img src="https://api.iconify.design/tabler/palette.svg?color=%23FFFFFF" width="20" /> Paleta de Cores do Projeto</h2>
...
<h2 align="center"><img src="https://api.iconify.design/tabler/users.svg?color=%23FFFFFF" width="20" /> Equipe</h2>
